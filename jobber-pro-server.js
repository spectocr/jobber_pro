                ...
                clientJobs.map(j => {
                    ...
                    return \`<tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-primary btn-small" onclick="window.open('/invoice/\${j._id || j.id}', '_blank')">📄</button>
                        </td>
                    </tr>\`;
                }).join('') +
                '</tbody></table>';
                ...
                filteredJobs.map(j => {
                    ...
                    return \`<tr>
                        ...
                        <td>
                            ...
                            \${isAdmin ? '<button class="btn btn-primary btn-small" onclick="window.open(\'/invoice/\${j._id || j.id}\', \'_blank\')">📄 Invoice</button>' : ''}
