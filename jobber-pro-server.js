...
<body>
    ...
    <script>
        ...
        function renderNJMap() {
            ...
            // Accurate New Jersey state outline
            svg.innerHTML = `
                <defs>
                ...
                <!-- Actual NJ state shape -->
                <path d="M 130,15 L 135,18 140,22 143,28 145,35 147,43 148,52 149,62 150,73 151,85 152,98 153,112 154,127 155,143 156,160 157,178 158,197 159,217 160,238 161,260 162,283 163,307 164,332 165,358 166,385 167,413 167.5,442 168,472 167.5,502 166,530 163,555 158,575 150,590 140,600 128,605 115,608 100,609 85,608 72,604 60,598 50,589 42,578 36,565 32,550 29,533 27,515 26,496 25.5,476 25,456 25,436 25.5,416 26,396 27,376 28.5,356 30,336 32,316 34.5,296 37,276 40,256 43.5,236 47,216 51,196 55.5,176 60,156 65,136 70.5,116 76,96 82,76 88.5,56 95,36 102,20 110,10 120,5 Z"
                      fill="url(#njGradient)"
                      stroke="#2563eb"
                      stroke-width="2"
